...
const [isVisisble, setIsVisisble] = useState(!!isOpen)
const {movieId} = useInfoModalStore()
const {data = {}} = useMovie(movieId)

useEffect(() => {
  setIsVisisble(!!isOpen)
...
if (!isOpen) {
  ...
  return (
    ...
    <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
      <div className={`${isVisisble ? 'scale-100' : 'scale-0'} transform duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
